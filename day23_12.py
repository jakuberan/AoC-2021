...
def room_tops(situation, base=7, room_size=room_size):
    """
...
def get_steps(i, j, base=7, room_size=room_size):
    """
...
def can_leave_room(situation, i, j, room_size=room_size, amph_map=amph_map, base=7):
    """
...
def can_go_to_room(situation, i, j, room_size=room_size, amph_map=amph_map, base=7):
    """
...
def generate_moves(
    situation, cost, costs=costs, base=7, room_size=room_size, amph_map=amph_map
):
    """
...
def all_not_home(situation, base=7, room_size=room_size):
    """
...
cost_best = 0
situ_used = {situ_best}
while all_not_home(situ_best):
    # Generate all possible moves from current situation
    situ_new, cost_new = generate_moves(situ_best, cost_best)
    situ_stack += situ_new
